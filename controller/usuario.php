<?php
    ...
    switch($_GET["op"]){
        case "guardaryeditar":
            if(empty($_POST["usu_id"])){  /* si desde la vista el usu_id viene vacio se procedera a registrar el usuraio */     
                $usuario->insert_usuario($_POST["usu_nom"],$_POST["usu_ape"],$_POST["usu_correo"],$_POST["usu_pass"],$_POST["rol_id"],$_POST["dep_id"]);     
            }
            else { /* si el usu id viene desde la vista se tendra una actualizacion del usuario */
                $usuario->update_usuario($_POST["usu_id"],$_POST["usu_nom"],$_POST["usu_ape"],$_POST["usu_correo"],$_POST["usu_pass"],$_POST["rol_id"],$_POST["dep_id"]);
            }
        break;
