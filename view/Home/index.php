<?php
  ...
  if(isset($_SESSION["usu_id"])){  /*Revisa si existe una sesion  */
?>
<!DOCTYPE html>
<html>
    <?php require_once("../MainHead/head.php");?> <!--Llama a head.php-->
	<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/morris.js/0.5.1/morris.css">
	<title>HS-CRM</title>
</head>
<body class="with-side-menu">

    <?php require_once("../MainHeader/header.php");?><!--Lamma a header.php-->
