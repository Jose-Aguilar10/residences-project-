  ...
  <body class="with-side-menu">
    ...
    <div class="page-content">
      <div class="container-fluid">
        ...
        <div class="box-typical box-typical-padding">   <!--  Detalles del tictket -->
          <div class="row">
          ...
          <div class="col-lg-12">
              ...
              <div class="col-lg-4">
                <fieldset class="form-group">
                  ...
                  <input type="text" class="form-control" id="cats_nom" name="cats_nom" readonly> <!-- el readonly permite que solo sea de lectura -->
                </fieldset>
              </div>
