...
class Email extends PHPMailer{
    ...
    protected $gCorreo = 'hotel_hotsson@hotmail.com';
    protected $gContrasena = 'Prueba123';
    public function ticket_abierto($tick_id){
        ...
        //IGual//
        $this->IsSMTP();
        $this->Host = 'smtp-mail.outlook.com';//Aqui el server
        $this->Port =  587;//Aqui el puerto
        $this->SMTPAuth = true;
        $this->Username = $this->gCorreo;
        $this->Password = $this->gContrasena;
        $this->From = $this->gCorreo; /* Este gCorreo es igual al que esta en la parte de arriba, donde se coloca la variable destinatario */
        $this->SMTPSecure = 'tls';
